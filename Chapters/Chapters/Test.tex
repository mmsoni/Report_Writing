...
%\newpage
%\section{Turbulent channel flow tests}
...
%\psfrag{x}[l][1][1][0]{$x_2^+$}
%\psfrag{y}[r][1][1][0]{}
%\subfigure[Zoom near the wall]{
%\includegraphics[width=5.5cm]{figur/balance_uv_zoom.eps}
%}
%\end{minipage}%
%\begin{minipage}[b]{0.5\textwidth}
...
%\includegraphics[width=5.5cm]{figur/balance_uv.eps}
%}
%\end{minipage}
